...
public class Customer{
    ...
    public Customer(String name, String birthday, String gender, int idCard, String numbersPhone, String email, String typeCustomer, String address,Services services) {
        this.name = name;
